...
> Note: This card requires the [Bus vertrektijden integration](https://github.com/kerstenremco/busvertrektijden-ha)
...
- Add this repository as a **custom repository** in HACS. Type **Dashboard**
  `https://github.com/kerstenremco/busvertrektijden-ha-card`
